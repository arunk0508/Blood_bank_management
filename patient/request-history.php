...
<div class="head-bar-1">
    ...
    <?php
       ...
       echo"<div class='list'>";
        echo"<p class='list-of-donors'>Your Requests</p>";
    echo"</div>";
    echo"<div class='main-body'>";
    $con=mysqli_connect($servername,$username,$password,$database);
    $q="select * from patientreq";
    $rl=mysqli_query($con,$q);

    echo"<table class='table' style='margin-left:560px;'>";
    echo"<tr><td>S.No</td><td>Request ID</td><td>units(in ml)</td><td>Status</td><td>Action</td></tr>";
    while($row=mysqli_fetch_array($rl)){
        echo"<tr><td>$row[sno]</td><td>$row[requestid]</td><td> $row[unit]</td> <td>$row[status]</td>";
